...
Статус: этапы 1–8 реализованы; кроме `order_paid` добавлены два минимально
необходимых письма о фактическом движении отправления СДЭК
...
| 8. Production и расширение | `order_paid`, СДЭК и безопасная подписка | 12, 15, 19 | `order_paid`, Single Opt-In, `shipment_handed_over` и `shipment_ready` реализованы с outbox, cutoff и мониторингом |
